...
#that the user wants to see.
    ...
    def graph_of_means(self, data, mean):
        ...
        print("In order to move on, you must close the graph")
        input("Press Enter to continue ")
        graph_data = mean[['Country', 'Classical', 'Pop', 'Rock', 'Punk', 'Hiphop', 'Swing', 'Alternative', 'Techno']].plot(kind='bar', title ="Music", figsize=(10, 9), legend=True, fontsize=12)
        graph_data.set_xlabel("Music Type", fontsize=12)
